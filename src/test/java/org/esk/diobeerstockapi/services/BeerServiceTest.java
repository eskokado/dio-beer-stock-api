...
public class BeerServiceTest {
    ...
    @Test
    void whenDecrementIsCalledThenDecrementBeerStock() throws BeerNotFoundException, BeerStockMinimunException {
        BeerDTO expectedBeerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
        Beer expectedBeer = beerMapper.toModel(expectedBeerDTO);
    ...
    @Test
    void whenDecrementIsCalledToEmptyStockThenEmptyBeerStock() throws BeerNotFoundException, BeerStockMinimunException {
        BeerDTO expectedBeerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
        Beer expectedBeer = beerMapper.toModel(expectedBeerDTO);
    ...
    void whenDecrementIsLowerThanZeroThenThrowException() {
        ...
        assertThrows(BeerStockMinimunException.class, () -> beerService.decrement(expectedBeerDTO.getId(), quantityToDecrement));
    }
